...
- **真正支持后端语言。** 基于 `web-tree-sitter`,首批一等公民支持 TypeScript、JavaScript、Vue、Go、Python —— 更多语言路上。
...
| Rust                      | tree-sitter-rust                          |  ☐ 规划中 |
| Java                      | tree-sitter-java                          |  ☐ 规划中 |
| C / C++                   | tree-sitter-cpp                           |  ☐ 规划中 |

新增一门语言主要就是在 `packages/repo-analyzer/src/parser/language-map.ts` 中注册其 Tree-sitter 语法,并适配符号抽取器。欢迎提 PR。
...
| Mintlify / JSDoc                | 仅覆盖前端生态                                  | 当前覆盖 Go、Python、Vue;Rust / Java / C++ 路上            |
...
| 多语言 AST 解析               |  ✅  | TypeScript / JavaScript / Vue SFC / Go / Python                       |
...
| Rust / Java / C++ AST 解析    |  ☐  | Tree-sitter 语法已就位,需补符号抽取器                                 |
